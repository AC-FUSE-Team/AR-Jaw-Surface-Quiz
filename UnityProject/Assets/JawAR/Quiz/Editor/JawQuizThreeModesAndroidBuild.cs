...
{
    /// <summary>Non-overwriting v35 build using the proven v34 Android/proxy pipeline.</summary>
    public static class JawQuizThreeModesAndroidBuild
    {
        public const string OutputPath = "/home/omar/JawRepair/JawSurfaceQuiz_v35_ThreeLearningModes.apk";
        public const string VersionName = "1.6.0-three-learning-modes";
        public const int VersionCode = 35;

        [MenuItem("Tools/Jaw Anatomy Quiz/Build v35 Three Learning Modes APK")]
